...
# %% auto 0
__all__ = ['Dataset', 'PointCloudVisualizer', 'run_viz', 'main_viz', 'save_clusters', 'verificar_consistencia_labels',
           'get_statistics', 'compute_cluster_features', 'extract_features_from_clusters', 'plot_1', 'plot_2', 'plot_3',
           'plot_4', 'plot_5']
...
class PointCloudVisualizer:
    ...
    def _show_clusters(
        ...
        **kwargs,
        ...
        true_label = point_cloud[:, 3]
        min_points = point_cloud[:, 4:7]
        max_points = point_cloud[:, 7:10]
        ...
        vis.create_window(window_name="Cluster Visualization", width=800, height=600)
...
def extract_features_from_clusters(point_cloud, drop_incosistentes=True, min_cluster_size=1):
    """
