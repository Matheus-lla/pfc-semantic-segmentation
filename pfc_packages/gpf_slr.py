# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_gpf_slr.ipynb.
...
# %% ../nbs/00_gpf_slr.ipynb 3
import numpy as np
from sklearn.neighbors import KDTree

# %% ../nbs/00_gpf_slr.ipynb 5
